    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <TouchableOpacity
              onPress={() => Alert.alert('Bookmark feature coming soon!')}
              style={{
                backgroundColor: 'rgba(255, 255, 255, 0.5)',
                borderRadius: 10,
                padding: 4,
      ...
      <Animated.View style={styles.footer} entering={SlideInDown.delay(200)}>
        <TouchableOpacity
          onPress={() => Alert.alert('Booking functionality coming soon!')}
          style={[styles.footerBtn, styles.footerBookBtn]}
        >
          <Text style={styles.footerBtnTxt}>Book Now</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => Alert.alert(`This trip costs $${listing.price}`)}
